-- First, update existing policies to remove role dependency from profiles
DROP POLICY IF EXISTS "Admins and reviewers can update results" ON public.medical_results;
